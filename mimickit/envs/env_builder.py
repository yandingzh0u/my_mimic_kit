...
def build_env(env_file, engine_file, num_envs, device, visualize, record_video=False):
    ...
    elif (env_name == "phase_transition_critic"):
        import envs.phase_transition_env as phase_transition_env
        env = phase_transition_env.PhaseTransitionCriticEnv(env_config=env_config, engine_config=engine_config, num_envs=num_envs, device=device, visualize=visualize, record_video=record_video)
