...
def build_env(env_file, engine_file, num_envs, device, visualize, record_video=False):
    ...
    elif (env_name == "st_add"):
        import envs.st_add_env as st_add_env
        env = st_add_env.STADDEnv(env_config=env_config, engine_config=engine_config, num_envs=num_envs, device=device, visualize=visualize, record_video=record_video)
    elif (env_name == "liesig_st_add"):
        import envs.liesig_st_add_env as liesig_st_add_env
        env = liesig_st_add_env.LieSigSTADDEnv(env_config=env_config, engine_config=engine_config, num_envs=num_envs, device=device, visualize=visualize, record_video=record_video)
    elif (env_name == "smp"):
