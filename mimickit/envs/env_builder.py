...
def build_env(env_file, engine_file, num_envs, device, visualize, record_video=False):
    ...
    elif (env_name == "cpmd_residual"):
        import envs.cpmd_residual_env as cpmd_residual_env
        env = cpmd_residual_env.CPMDResidualEnv(env_config=env_config, engine_config=engine_config, num_envs=num_envs, device=device, visualize=visualize, record_video=record_video)
    elif (env_name == "smp"):
